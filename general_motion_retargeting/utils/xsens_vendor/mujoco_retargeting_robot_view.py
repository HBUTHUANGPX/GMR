...
if __name__ == "__main__":
    ...
    retargeting_data_file_name = (
        ...
        + "retargeting_data/Q1/xsens_bvh/251021/251021_01_slowly_walk_120Hz.pkl"
    ...
    # d.save_as_csv("lafan_XS3/251014_single_action/251014_single_action_forward_walk.csv")
    d.animate_bvh()
